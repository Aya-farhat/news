    ...
    return Scaffold(
      ...
      body:Stack(
        ...
        Align(
           ...
           decoration: BoxDecoration(image: DecorationImage(image: NetworkImage(imageUri),
           fit: BoxFit.fill)),
            ),
          ),
         Align(
                ...
                decoration:  BoxDecoration(
                    ...
                    child:Padding(
                      ...
                      child: Column(
                       ...
                       Text( description ?? "Crypto investors should be prepared to lose all their money, BOE governor says",
                              style: TextStyle(fontSize: 16,color: Color.fromARGB(255, 5, 5, 5),fontWeight: FontWeight.bold)),

                           Text( author ?? "Published by Ryan Browne",
